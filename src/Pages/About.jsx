    ...
    return (
        <>
            <div>
                ...
                <div className='flex lg:flex-row md:flex-col sm:flex-col items-center justify-center gap-20 text-white px-40 py-20 bg-cover bg-no-repeat'
                    style={{backgroundImage: "url('Mission.jpg')"}}
                >
                    <div className='flex flex-col gap-7'>
                        <p className='text-2xl'>MISSION</p>
                        <div>
                            <p className='border-r-2 border-gray-400 lg:w-[50vh] md:w-[70vh] sm:w-[40vh] text-lg pr-5'>create a transparent, efficient, and inclusive agricultural marketplace that connects farmers, buyers, 
                    ...
                    <div className='flex flex-col gap-7'>
                        ...
                        <p className='border-r-2 border-gray-400 lg:w-[50vh] md:w-[70vh] sm:w-[40vh] text-lg pr-5'>                                                    
                    ...
                    <div className='flex flex-col gap-7'>
                        ...
                        <div>
                            <ol className='lg:w-[50vh] md:w-[70vh] sm:w-[40vh] text-lg'>
                                <li>Transparency</li>
                                <li>Empowerment</li>
